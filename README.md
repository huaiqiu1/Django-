...
```
       public function get_single_stat($card) {
		$sql = "SELECT `jz_doublecard_info_oppoaccount`, `jz_doublecard_info_intotal`, `jz_doublecard_info_incount`,  
		       ...
		       `jz_doublecard_info_outaverage`,`jz_doublecard_info_inshengoucount`+`jz_doublecard_info_outshengoucount` AS 
		       `jz_doublecard_info_shengoucount`, `jz_doublecard_info_infanlicount`+`jz_doublecard_info_outfanlicount` AS 
		       `jz_doublecard_info_fanlicount` FROM `jz_doublecard_info` WHERE `jz_doublecard_info_currentaccount` = '{$card}'";
		$res = $this->db->query($sql);
		$list_a2b = $res->result_array();
		$sql = "SELECT `jz_bankwater_qvzaoinfo_transcatdata`, `jz_bankwater_qvzaoinfo_transcatamount`, 
		       `jz_bankwater_qvzaoinfo_balance`, `jz_bankwater_qvzaoinfo_inoroutsign`, `jz_bankwater_qvzaoinfo_oppoaccount`, 
		       `jz_bankwater_qvzaoinfo_abstract`, `jz_bankwater_qvzaoinfo_transactbankname` FROM `jz_bankwater_qvzaoinfo` WHERE 
		...
		$sql = "SELECT * FROM `jz_single_day_bankwater_info` WHERE `jz_single_day_bankwater_info_productcode` = '{$card}'";
		$res = $this->db->query($sql);
